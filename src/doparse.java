...
//department, number, title, teacher, student
					{
						 ...
						 if(node_inner.item(i).getNodeName() == "students"){
							 ...
							 List<Person> studentlist = null ;// temp list to add to main
							 ...
							 for(int j=0;j<node_student.getLength();j++)//person
							 {
								 ...
								 System.out.print( node_person.getLength()+ "node ");
								 for(int k=0;k<node_person.getLength();k++)
								 {
								  ...
								  //System.out.println("student 1"+student.getName());
								//studentlist.add(student);//  adds the temp student to the list
